  ...
  const handleNext = async () => {
    ...
    if (step < steps.length - 1) {
      ...
      if (user) {
        ...
        // Pull the booking_code now that the profile row is settled, so we
        // can hand the doctor their public link on the celebration screen.
        // The code is auto-generated by the DB on insert — should be there.
        // If it's missing for any reason we just skip to the dashboard.
